...
namespace PhoenixRising.BetterClasses.Tactical.Entities.DamageKeywords
{
    internal class SharedSoloEffectorDamageKeywordsDataDef
    {
        ...
        {
            SharedDamageKeywordsDataDef sharedDamageKeywords = BetterClassesMain.Shared.SharedDamageKeywords;
