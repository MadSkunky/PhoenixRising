    ...
    class WeaponModifications
    {
        ...
        public static void ApplyChanges()
        {
            try
            {
                ...
                ShootAbilityDef singleBurst = Helper.CreateDefFromClone(
                    weaponShoot,
                    "f87aa4d0-acfc-4deb-b617-906a1db1618f",
                    skillName);
                singleBurst.ActionPointCost = 0.25f;
                singleBurst.ExecutionsCount = 1;
                TacticalAbilityViewElementDef sbVisuals = Helper.CreateDefFromClone(
                ...
                ShootAbilityDef doubleBurst = Helper.CreateDefFromClone(
                    weaponShoot,
                    "51e33db7-6bec-4144-8f9f-d23dc25e3e67",
                    skillName);
                doubleBurst.ActionPointCost = 0.5f;
                doubleBurst.ExecutionsCount = 2;
                TacticalAbilityViewElementDef dbVisuals = Helper.CreateDefFromClone(
                    weaponShoot.ViewElementDef,
                ...
                ShootAbilityDef tripleBurst = Helper.CreateDefFromClone(
                    weaponShoot,
                    "5548762b-61ae-45c8-ae09-ee8163b423c3",
                    skillName);
                tripleBurst.ActionPointCost = 0.75f;
                tripleBurst.ExecutionsCount = 3;
                TacticalAbilityViewElementDef tbVisuals = Helper.CreateDefFromClone(
                    weaponShoot.ViewElementDef,
